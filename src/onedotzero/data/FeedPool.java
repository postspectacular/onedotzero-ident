...
public class FeedPool {
    ...
    protected static final Logger logger =
            Logger.getLogger(FeedPool.class.getName());

    protected HashMap<String, FeedConfiguration> feedMap =
            new HashMap<String, FeedConfiguration>();

    protected ArrayList<FeedConfiguration> feedList =
            new ArrayList<FeedConfiguration>();
