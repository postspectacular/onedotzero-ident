...
public class OSCManager {
	...
	private static final Logger logger = Logger.getLogger(OSCManager.class
			.getName());

	OscP5 osc;

	ArrayList<InteractionStateListener> listeners = new ArrayList<InteractionStateListener>();
